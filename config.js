...
module.exports = {
  ...
  OWNER_NAME: process.env.OWNER_NAME || "ℂ𝔸𝕊ℙ𝔼ℝ",
  BOT_NAME: process.env.BOT_NAME || "𝕋ℝ𝔸𝔹𝕐-𝚅3",
  SUDO: process.env.SUDO || null,
  LANG: process.env.LANGUAGE === undefined ? 'EN' : process.env.LANGUAGE.toUpperCase(),
  STICKER_PACKNAME: process.env.STICKER_PACKNAME || "Traby-v3,❤️",
  AUDIO_DATA: process.env.AUDIO_DATA || "Eʏᴘᴢ;Iᴢᴜᴍɪ-ᴠ3;https://i.imgur.com/cO0TZJv.jpeg",
  PROCESSNAME: process.env.PROCESSNAME || "Traby-v3",
